 ...
 * @author PC
 */
@WebServlet(name = "cineServlet", urlPatterns = {"/cineServlet"})
public class cineServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet cineServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet cineServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int pagoTotal = cantidadBoletos * precioBoleto;
        
        //Generar asientos aleatorios
        //Generear letras aleatorias 
        String letras = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
        char letraAleatoriea = letras.charAt((int) (Math.random() * letras.length()));
        
        //Generar numeros aleatorios
        int numeroAleatorio = 1 + (int) (Math.random() * 20);
        
        //Combinar letra y numero
        String identificadorAsiento = String.valueOf(letraAleatoriea) + numeroAleatorio;
        ...
        String contenidoBoleto = "----- BOLETO DE TEATRO -----\n"
                ...
                + "Fecha: " + fecha + "\n"
                + "Hora: " + hora + "\n"
                + "Nombre de pelicula: " + pelicula + "\n"
                + "Tipo de sala: " + nombreTitular + "\n"
